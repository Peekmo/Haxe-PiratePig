...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Peekmo", "Haxe-PiratePig", "com.example.myapp", "0.0.1");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Haxe Pirate Pig", null, { width: 500, height: 600 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 500, height: 600 });
			#end
