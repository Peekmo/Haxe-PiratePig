...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/sounds/whiff.wav", __ASSET__assets_sounds_whiff_wav);
		type.set ("assets/sounds/whiff.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
		className.set ("assets/sounds/4.ogg", __ASSET__assets_sounds_4_ogg);
		type.set ("assets/sounds/4.ogg", Reflect.field (AssetType, "sound".toUpperCase ()));
		className.set ("assets/sounds/theme.mp3", __ASSET__assets_sounds_theme_mp3);
		type.set ("assets/sounds/theme.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
		className.set ("assets/sounds/5.ogg", __ASSET__assets_sounds_5_ogg);
		type.set ("assets/sounds/5.ogg", Reflect.field (AssetType, "sound".toUpperCase ()));
		className.set ("assets/sounds/3.ogg", __ASSET__assets_sounds_3_ogg);
		type.set ("assets/sounds/3.ogg", Reflect.field (AssetType, "sound".toUpperCase ()));
		className.set ("assets/sounds/whiff.ogg", __ASSET__assets_sounds_whiff_ogg);
		type.set ("assets/sounds/whiff.ogg", Reflect.field (AssetType, "sound".toUpperCase ()));
		className.set ("assets/sounds/3.wav", __ASSET__assets_sounds_3_wav);
		type.set ("assets/sounds/3.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
		className.set ("assets/sounds/whiff.mp3", __ASSET__assets_sounds_whiff_mp3);
		type.set ("assets/sounds/whiff.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
		className.set ("assets/sounds/4.wav", __ASSET__assets_sounds_4_wav);
		type.set ("assets/sounds/4.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
		className.set ("assets/sounds/5.wav", __ASSET__assets_sounds_5_wav);
		type.set ("assets/sounds/5.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
		className.set ("assets/sounds/5.mp3", __ASSET__assets_sounds_5_mp3);
		type.set ("assets/sounds/5.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
		...
		className.set ("assets/sounds/3.mp3", __ASSET__assets_sounds_3_mp3);
		type.set ("assets/sounds/3.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
		className.set ("assets/sounds/theme.ogg", __ASSET__assets_sounds_theme_ogg);
		type.set ("assets/sounds/theme.ogg", Reflect.field (AssetType, "sound".toUpperCase ()));
		className.set ("assets/sounds/4.mp3", __ASSET__assets_sounds_4_mp3);
		type.set ("assets/sounds/4.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
		className.set ("assets/images/icon.svg", __ASSET__assets_images_icon_svg);
		type.set ("assets/images/icon.svg", Reflect.field (AssetType, "text".toUpperCase ()));
		className.set ("assets/images/game_bunny_02.png", __ASSET__assets_images_game_bunny_02_png);
		type.set ("assets/images/game_bunny_02.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("assets/images/game_carrot.png", __ASSET__assets_images_game_carrot_png);
		type.set ("assets/images/game_carrot.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("assets/images/center_bottom.png", __ASSET__assets_images_center_bottom_png);
		type.set ("assets/images/center_bottom.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("assets/images/background_tile.png", __ASSET__assets_images_background_tile_png);
		type.set ("assets/images/background_tile.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("assets/images/game_piratePig.png", __ASSET__assets_images_game_piratepig_png);
		type.set ("assets/images/game_piratePig.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("assets/images/game_panda.png", __ASSET__assets_images_game_panda_png);
		type.set ("assets/images/game_panda.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("assets/images/game_lemon.png", __ASSET__assets_images_game_lemon_png);
		type.set ("assets/images/game_lemon.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("assets/images/game_bear.png", __ASSET__assets_images_game_bear_png);
		type.set ("assets/images/game_bear.png", Reflect.field (AssetType, "image".toUpperCase ()));
		...
		className.set ("assets/data/FreebooterUpdated.ttf", __ASSET__assets_data_freebooterupdated_ttf);
		type.set ("assets/data/FreebooterUpdated.ttf", Reflect.field (AssetType, "font".toUpperCase ()));
		...
		path.set ("assets/sounds/whiff.wav", "assets/sounds/whiff.wav");
		type.set ("assets/sounds/whiff.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
		path.set ("assets/sounds/4.ogg", "assets/sounds/4.ogg");
		type.set ("assets/sounds/4.ogg", Reflect.field (AssetType, "sound".toUpperCase ()));
		path.set ("assets/sounds/theme.mp3", "assets/sounds/theme.mp3");
		type.set ("assets/sounds/theme.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
		path.set ("assets/sounds/5.ogg", "assets/sounds/5.ogg");
		type.set ("assets/sounds/5.ogg", Reflect.field (AssetType, "sound".toUpperCase ()));
		path.set ("assets/sounds/3.ogg", "assets/sounds/3.ogg");
		type.set ("assets/sounds/3.ogg", Reflect.field (AssetType, "sound".toUpperCase ()));
		path.set ("assets/sounds/whiff.ogg", "assets/sounds/whiff.ogg");
		type.set ("assets/sounds/whiff.ogg", Reflect.field (AssetType, "sound".toUpperCase ()));
		path.set ("assets/sounds/3.wav", "assets/sounds/3.wav");
		type.set ("assets/sounds/3.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
		path.set ("assets/sounds/whiff.mp3", "assets/sounds/whiff.mp3");
		type.set ("assets/sounds/whiff.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
		path.set ("assets/sounds/4.wav", "assets/sounds/4.wav");
		type.set ("assets/sounds/4.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
		path.set ("assets/sounds/5.wav", "assets/sounds/5.wav");
		type.set ("assets/sounds/5.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
		path.set ("assets/sounds/5.mp3", "assets/sounds/5.mp3");
		type.set ("assets/sounds/5.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
		path.set ("assets/sounds/theme.wav", "assets/sounds/theme.wav");
		type.set ("assets/sounds/theme.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
		path.set ("assets/sounds/3.mp3", "assets/sounds/3.mp3");
		type.set ("assets/sounds/3.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
		path.set ("assets/sounds/theme.ogg", "assets/sounds/theme.ogg");
		type.set ("assets/sounds/theme.ogg", Reflect.field (AssetType, "sound".toUpperCase ()));
		path.set ("assets/sounds/4.mp3", "assets/sounds/4.mp3");
		type.set ("assets/sounds/4.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
		path.set ("assets/images/icon.svg", "assets/images/icon.svg");
		type.set ("assets/images/icon.svg", Reflect.field (AssetType, "text".toUpperCase ()));
		path.set ("assets/images/game_bunny_02.png", "assets/images/game_bunny_02.png");
		type.set ("assets/images/game_bunny_02.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("assets/images/game_carrot.png", "assets/images/game_carrot.png");
		type.set ("assets/images/game_carrot.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("assets/images/center_bottom.png", "assets/images/center_bottom.png");
		type.set ("assets/images/center_bottom.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("assets/images/background_tile.png", "assets/images/background_tile.png");
		type.set ("assets/images/background_tile.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("assets/images/game_piratePig.png", "assets/images/game_piratePig.png");
		type.set ("assets/images/game_piratePig.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("assets/images/game_panda.png", "assets/images/game_panda.png");
		type.set ("assets/images/game_panda.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("assets/images/game_lemon.png", "assets/images/game_lemon.png");
		type.set ("assets/images/game_lemon.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("assets/images/game_bear.png", "assets/images/game_bear.png");
		type.set ("assets/images/game_bear.png", Reflect.field (AssetType, "image".toUpperCase ()));
...
class __ASSET__assets_sounds_whiff_wav extends null { }
class __ASSET__assets_sounds_4_ogg extends null { }
class __ASSET__assets_sounds_theme_mp3 extends null { }
class __ASSET__assets_sounds_5_ogg extends null { }
class __ASSET__assets_sounds_3_ogg extends null { }
class __ASSET__assets_sounds_whiff_ogg extends null { }
class __ASSET__assets_sounds_3_wav extends null { }
class __ASSET__assets_sounds_whiff_mp3 extends null { }
class __ASSET__assets_sounds_4_wav extends null { }
class __ASSET__assets_sounds_5_wav extends null { }
class __ASSET__assets_sounds_5_mp3 extends null { }
class __ASSET__assets_sounds_theme_wav extends null { }
class __ASSET__assets_sounds_3_mp3 extends null { }
class __ASSET__assets_sounds_theme_ogg extends null { }
class __ASSET__assets_sounds_4_mp3 extends null { }
class __ASSET__assets_images_icon_svg extends null { }
class __ASSET__assets_images_game_bunny_02_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__assets_images_game_carrot_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__assets_images_center_bottom_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__assets_images_background_tile_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__assets_images_game_piratepig_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__assets_images_game_panda_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__assets_images_game_lemon_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__assets_images_game_bear_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__assets_images_logo_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__assets_music_music_goes_here_txt extends null { }
class __ASSET__assets_data_freebooterupdated_ttf extends null { }
...
class __ASSET__assets_data_freebooterupdated_ttf extends flash.text.Font { }
